...
<html>
  ...
  <body>
    ...
    <div id="login" title="管理员登录" style="width:300px;height:200px;"   
	  ...
	  <form  id="loginInputForm" method="post" action="/LoginManagerServlet">
	  ...
	  <tr>
	  	...
	  	<tr>
			...
			<td >
				<input type="text" id="name" class="easyui-validatebox" data-options="required:true,missingMessage:'请输入用户名!'" name="name" value="${name}"/>
			</td>	
		</tr>
		<tr>
			<th align="right"  height="40" width="80">密码</th>
			<td >
				<input type="password" id="password" class="easyui-validatebox" data-options="required:true,missingMessage:'请输入密码!'" name="password" value="${password }"/>
			</td>		
		</tr>
	  </table>
