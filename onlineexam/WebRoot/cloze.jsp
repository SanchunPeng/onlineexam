...
<html>
  <head>
    ...
    <title>My JSP 'cloze.jsp' starting page</title>
  ...
  <body>
    ...
    <div data-options="region:'center',title:'填空题列表'" >
    	<script type="text/javascript" src="myjs/cloze.js"></script>
  		<table id="datagridCloze" >
 		 </table>	
